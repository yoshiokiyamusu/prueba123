                  ...
                  ?>
                       <tr>
                            ...
                            <td class="col-md-1"><h4>
                              ...
                              <input  class="form-control col-sm-12" id="" type="text" name="<?php echo $nameqtyout; ?>" value="<?php echo utf8_encode($record->qty_in);?>" readonly></input>
                            </h4></td>
                      </tr>
...
<!-- JS para la tabla dinamica con filtros -->
  <script src="<?php echo url_for('ajax/gest-inventarios/retorno/botones.js'); ?>"></script>
