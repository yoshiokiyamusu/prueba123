...
<?php
   ...
   if($current_os == ''){
     $url = 'view-orden_de_servicio/agregar_orden_confbordado.php?';
...
<section class="alternate page-heading">
  <div class="container">
    <h1>Confirmar orden de Confección y bordado</h1>
...
<script src="<?php echo url_for('ajax/orden_de_servicio/botones_confbordado.js'); ?>"></script>
