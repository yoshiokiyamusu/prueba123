...
<?php
   ...
   if($current_os == ''){
     $url = 'view-orden_de_servicio/agregar_orden_confensamblaje.php?';
...
<section class="alternate page-heading">
  <div class="container">
    <h1>Confirmar orden confección y ensamblaje</h1>
...
<script src="<?php echo url_for('ajax/orden_de_servicio/botones_confensamblaje.js'); ?>"></script>
